...
use rectangle::{preprocess_words, step_word_rectangle, CrushedWords, WordRectangle, WordsMatch};

fn criterion_benchmark(c: &mut Criterion) {
    let mut words = Vec::new();
    let fixed_slab: Arena<CrushedWords> = Arena::new();
    ...
    c.bench_with_input(
        ...
        |b, (words_by_length_borrowed, caches)| {
            b.iter(|| {
                ...
                let local_slab: Arena<CrushedWords> = Arena::new();
